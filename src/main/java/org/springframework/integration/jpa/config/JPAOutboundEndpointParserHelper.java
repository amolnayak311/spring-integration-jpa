...
import org.springframework.integration.jpa.JpaMessageHandlerFactory;
 ...
 *
 */
public class JPAOutboundEndpointParserHelper {
	...
	public static BeanDefinitionBuilder getMessageHandlerBuilder(Element element,
		...
		BeanDefinitionBuilder  messageHandlerFactoryBuilder = 
				BeanDefinitionBuilder.genericBeanDefinition(JpaMessageHandlerFactory.class);
	...
	private static String getJpaOperationsRefName(Element element,ParserContext parserContext) {
		...
		IntegrationNamespaceUtils.setReferenceIfAttributeDefined(builder, element, "entity-manager-factory");
